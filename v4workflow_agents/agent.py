...
# Agents
# root_agent -|
#             |- film_concept_team -| (SEQUENTIAL)
#                                   |- writers_room -| (LOOP w/exit_loop tool)
#                                   |                |- researcher
#                                   |                |- screenwriter
#                                   |                |- critic
#                                   |
...
#                                   |                      |- casting_agent
#                                   |- file_writer
# Whats new: Now we have a flow!  Create a concept, iterate on it, write it to a file.
# Then we research box office success potential as well as who should star in our film!
...
casting_agent = Agent(
    ...
    based on who has had received good critical feedback on similar roles in the past.
    """,
