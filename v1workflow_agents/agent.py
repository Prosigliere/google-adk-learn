...
#                                   |- screenwriter
#                                   |- file_writer
# This is the baseline work we will build from.
# Compare this tool to the last.  Notice it runs models sequentially vs the other that required human input to go from 1 to the other.
